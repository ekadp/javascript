BACKGROUND ANIMATION, Copyright (c) 2005, Programmer: Eka Dharma Pranoto, S.Kom., Aff.WM., 
...
--- HOW TO LEARN ---
Just open this "background.html" using Notepad++, Notepad, or other code editor.
...
--- SAMPLE SCREENSHOOT ---
Please see the screenshoot in file "background.png" in this folder. 
